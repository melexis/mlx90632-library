...
void test_dsp_object(void)
{
    ...
    TEST_ASSERT_DOUBLE_WITHIN(0.01, 193.917, dspv5_object_helper(26901, 26899, 22454, 23030));
    TEST_ASSERT_DOUBLE_WITHIN(0.01, 194.599, dspv5_object_helper(27105, 27095, 22454, 23030));
}
